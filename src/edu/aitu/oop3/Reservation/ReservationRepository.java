...
public class ReservationRepository implements IReservationRepository {
    ...
    public ReservationRepository(IDB db) { this.db = db; }
    ...
    public boolean createReservation(Reservation reservation) {
        ...
        try {
            ...
            st.execute();
            return true;
        } catch (SQLException | ClassNotFoundException e) { e.printStackTrace(); return false; }
        finally { try { if (con != null) con.close(); } catch (SQLException e) {} }
    }

    @Override
    public List<Reservation> getReservationsByGuestId(int guestId) { return new ArrayList<>(); }
